...
template <typename T, void (T::*mf)(), const char N[]> struct proxy<void (T::*)(), mf, N> {
...
static const struct luaL_Reg hole[] = {
    {"pipeline", safe_call<pipeline_new>}, {"filter_xor", safe_call<filter_xor_new>}, {NULL, NULL}};

static const struct luaL_Reg hole_io_object[] = {{"tun", safe_call<tun_new>},
