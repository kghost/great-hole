...
public:
  ...
  generator(generator&& other) noexcept : _Coro(other._Coro) { other._Coro = nullptr; }
  ...
  public:
    ...
    void operator++(int) { _Coro.resume(); }
    const T& operator*() const { return *_Coro.promise().value; }
